...
\begin{columns}
	\begin{column}{0.55\textwidth}
		\centering
		\only<1-2>{\includegraphics[scale=0.35]{Figures/track_k.png}}\only<3>{\includegraphics[scale=0.35]{Figures/track_k_time_t.png}}\only<4->{\includegraphics[scale=0.35]{Figures/track_filed.png}}
	\end{column}
